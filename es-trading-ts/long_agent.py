# Long Agent for TradeStation
# EMA Crossover + TTM Squeeze Strategy - Long Positions Only
...
class LongAgent:
    ...
    3. Squeeze momentum is positive (bullish) - REQUIRED
    4. Momentum is rising (bars getting taller) - bonus
    ...
    def _check_exit_signals(
        ...
        # 5. Squeeze momentum turned bearish with profit
        if indicators.squeeze_direction == -1 and pnl_ticks > 8:
            should_exit = True
            reasons.append("Momentum turned bearish + profit")
